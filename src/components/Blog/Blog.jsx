            ...
            <div className="container page-padding py-[10rem]">
                ...
                <div className="flex flex-col text-center relative items-center">
                    ...
                    <p className="text-[#646464] font-medium text-[15px]">
                        Gymate an unknown printer took a gallery of type and scrambled
                ...
                <div className="flex gap-6 w-full mt-[5rem] md1200:justify-center flex-wrap">
                    ...
                    <BlogBox
                        bgClass="box3Bg"
                        date="30.03.23"
                        title="Meet Fitness Ambassador Nanon"
                        description="Get to know Nanon, a fitness enthusiast and dedicated ambassador who is passionate about helping others reach their fitness goals." 
                    />
                </div>
            </div>
